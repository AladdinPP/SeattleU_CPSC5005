...
// FILENAME:    p2.cpp
// DATE:        10/31/2023
// PURPOSE:     This program test the template BST functions with integer
//              values and string values. It prompts for user input of
//              filename and read from the file to insert elements into BST.
// INPUT:       Filename prompted from users
// PROCESS:     Open the file and read from it to insert values into BST
// OUTPUT:      Display all the result returned from the BST class functions
...
int main() {
    ...
    // welcome message
    cout << "Welcome to the PLAY WITH BST program! Here, you can play with\n"
            "the binary search tree using any files (text or numeric) you\n"
            "have. The program will create a BST based on the file you\n"
            "provide. You can get the height, three orders displays,\n"
            "insert new elements, remove elements, check if a specific\n"
            "element is in the tree, etc." << endl;
